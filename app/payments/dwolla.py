...
class Dwolla:
    ...
    def create_personal_customer(self, firstName, lastName, email, address1, city, state, postalCode, dateOfBirth, ssn):
        request_body = {
            'firstName': firstName,
            'lastName': lastName,
            'email': email,
    ...
    def create_business_customer(self, firstName, lastName, email, ipAddress, address1, city, state, postalCode, controller, businessClassification, businessType, businessName, ein):
        request_body = None
