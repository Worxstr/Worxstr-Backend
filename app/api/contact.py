...
def support():
    ...
    if current_user.is_authenticated:
        ...
        name = get_request_json(request, "contact_name", optional=True) or "Unknown"
        phone = build_phone_number(
            get_request_json(request, "phone", optional=True) or None
        )
...
def create_support_ticket(
    ...
    payload = {
        ...
        "custom_fields": [
            {
                "id": "c2891b23-0a2d-4a53-8feb-c77171d3df99",
                "value": browser,
            },  # Browser Information
            ...
            {
                "id": "8cafe79d-6b05-43f6-8be3-bd8291e18ba9",
                "value": description,
            },  # Description
            {
                "id": "df2c9793-df47-432a-9d51-c8c2bfad9da7",
                "value": device,
            },  # Device Type
            {"id": "3dbe29b4-02ec-41ff-83dd-7e2b0b6d9dff", "value": email},  # Email
            {"id": "d7d4ceec-22e0-4bca-a962-f18a937c507e", "value": engine},  # Engine
            {
                "id": "55c2e4e1-b127-4e57-9835-93fd3c9e8a1a",
                "value": os,
            },  # OS Information
            {
                "id": "7b61b15e-7ab0-47a3-b9c0-a0e209e888ed",
                "value": user_agent,
            },  # User Agent
